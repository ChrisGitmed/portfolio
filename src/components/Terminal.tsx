...
import { argTab } from "../utils/helpers";
...
export const commands: Command = [
  { cmd: "about", desc: "Display some info about me", tab: 8 },
  { cmd: "clear", desc: "Clear the terminal", tab: 8 },
  { cmd: "echo", desc: "Print anything to the console", tab: 9 },
  { cmd: "email", desc: "Send me an email", tab: 8 },
  { cmd: "help", desc: "List the available commands", tab: 9 },
  { cmd: "history", desc: "View the command history", tab: 6 },
  { cmd: "projects", desc: "View some of my favorite creations", tab: 5 },
  { cmd: "pwd", desc: "Prints current working directory", tab: 10 },
  { cmd: "socials", desc: "Display my social accounts", tab: 6 },
  { cmd: "welcome", desc: "Display a welcome message", tab: 6 },
  { cmd: "whoami", desc: "Print the current user", tab: 7 },
];
